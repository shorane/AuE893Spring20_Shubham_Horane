...
def poseCallback(pose_message):
    global x
    global y, yaw
    x= pose_message.turtlebot3_burger.position.x
    y= pose_message.turtlebot3_burger.position.y
    yaw = pose_message.turtlebot3_burger.orientation.z
...
def rotate (angular_speed, relative_angle_degree, clockwise):
    ...
    while True :
        ...
        current_angle_degree = abs((yaw - theta0)*(180/pi))
        loop_rate.sleep()
